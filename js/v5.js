/**
 * ============================================================================
 * BLAKE3 — Naive JavaScript Implementation (Working v5)
 * ============================================================================
 * 
...
/**
 * ============================================================================
 * BLAKE3 v5 — Zero-copy — in-place writing
 * ============================================================================
 * 
 ...
 *       Result: ~6.2x speedup (from 64.7 ms to 10.4 ms on 1 MB of data)
 */
...
function compress(
  ...
  for (let round = 0; round < 7; ++round) {
    ...
    // G(0, 4, 8, 12)
    s_0 = (((s_0 + s_4) | 0) + m[mOffset + PERMUTATIONS[p++]]) | 0;
    s_12 ^= s_0;
    ...
    // G(1, 5, 9, 13)
    s_1 = (((s_1 + s_5) | 0) + m[mOffset + PERMUTATIONS[p++]]) | 0;
    s_13 ^= s_1;
    ...
    // G(2, 6, 10, 14)
    s_2 = (((s_2 + s_6) | 0) + m[mOffset + PERMUTATIONS[p++]]) | 0;
    s_14 ^= s_2;
    ...
    // G(3, 7, 11, 15)
    s_3 = (((s_3 + s_7) | 0) + m[mOffset + PERMUTATIONS[p++]]) | 0;
    s_15 ^= s_3;
    ...
    // G(0, 5, 10, 15)
    s_0 = (((s_0 + s_5) | 0) + m[mOffset + PERMUTATIONS[p++]]) | 0;
    s_15 ^= s_0;
    s_15 = (s_15 >>> 16) | (s_15 << 16);
    s_10 = (s_10 + s_15) | 0;
    s_5 ^= s_10;
    ...
    // G(1, 6, 11, 12)
    s_1 = (((s_1 + s_6) | 0) + m[mOffset + PERMUTATIONS[p++]]) | 0;
    s_12 ^= s_1;
    s_12 = (s_12 >>> 16) | (s_12 << 16);
    s_11 = (s_11 + s_12) | 0;
    s_6 ^= s_11;
    ...
    // G(2, 7, 8, 13)
    s_2 = (((s_2 + s_7) | 0) + m[mOffset + PERMUTATIONS[p++]]) | 0;
    s_13 ^= s_2;
    s_13 = (s_13 >>> 16) | (s_13 << 16);
    s_8 = (s_8 + s_13) | 0;
    s_7 ^= s_8;
    ...
    // G(3, 4, 9, 14)
    s_3 = (((s_3 + s_4) | 0) + m[mOffset + PERMUTATIONS[p++]]) | 0;
    s_14 ^= s_3;
    s_14 = (s_14 >>> 16) | (s_14 << 16);
    s_9 = (s_9 + s_14) | 0;
    s_4 ^= s_9;
