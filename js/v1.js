...
/**
 * ============================================================================
 * BLAKE3 v1 — Block Reading Optimization
 * ============================================================================
 * 
 * Optimizations in this version:
 * - v1: Removed array bounds checking from the "hot" loop
 *       
 *       Before (v0): single readLittleEndianWords function with checks on every iteration
 *       After (v1): two specialized functions:
 *         - readLittleEndianWordsFull: for full 64-byte blocks (no bounds checking)
 *         - readLittleEndianWordsPartial: for the last block (with bounds checking)
 *       
 *       Result: ~85x speedup (from 22.4s to 262ms per 1MB)
 */
